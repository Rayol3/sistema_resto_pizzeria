...
Route::post('/load-carousel'            , [InitController::class, 'load_carousel'])->name('admin.load_carousel');

Route::get('/menu'                      , [MenuController::class, 'index'])->name('menu');
Route::post('/search-category'          , [MenuController::class, 'search_category'])->name('admin.search_category');
Route::post('/load-cart-order'          , [MenuController::class, 'load_cart_order'])->name('admin.load_cart_order');
Route::post('/add-product-cart'         , [MenuController::class, 'add_product'])->name('admin.add_product_cart');


Route::get('/checkout'                  , [CheckoutController::class, 'index'])->name('checkout'); // 
Route::post('/load-cart-checkout'       , [CheckoutController::class, 'load_cart_checkout'])->name('admin.load_cart_checkout');
Route::post('/delete-item-order'        , [CheckoutController::class, 'delete_item'])->name('admin.delete_item_order');
Route::post('/store-product-order'      , [CheckoutController::class, 'store_product'])->name('admin.store_product_cart');
Route::post('/confirm-order'            , [CheckoutController::class, 'confirm_order'])->name('admin.confirm_order');


Route::get('/orders'                    , [OrderController::class, 'index'])->name('admin.orders')->middleware('auth');
Route::post('/load-orders'              , [OrderController::class, 'load_orders'])->name('admin.load_orders');
Route::post('/search-client-order'      , [OrderController::class, 'search_client'])->name('admin.search_client_order');
Route::post('/load-resumen-order'       , [OrderController::class, 'load_resumen'])->name('admin.load_resumen_order');
Route::post('/gen-command-order'        , [OrderController::class, 'gen_command'])->name('admin.gen_command_order');
...
Route::post('/login-auth'               , [LoginController::class, 'login'])->name('login.login');
...
# Comment
Route::get('/comments'                  , [CommentController::class, 'index'])->middleware('auth')->name('admin.comments');
Route::post('/save-comment'             , [CommentController::class, 'save'])->name('admin.save_comment');
...
// Restaurant
Route::get('/restaurant'                , [RestaurantController::class, 'index'])->middleware('auth')->name('admin.restaurant');
Route::post('/save-info-rest'           , [RestaurantController::class, 'save_info'])->name('admin.save_info_rest');
Route::post('/load-country'             , [RestaurantController::class, 'load_country'])->name('admin.load_country');

## Country
Route::get('/countries'                 , [CountryController::class, 'index'])->name('admin.countries')->middleware('auth');
Route::get('/get-countries'             , [CountryController::class, 'get'])->name('admin.get_countries');
Route::post('/save-country'             , [CountryController::class, 'save'])->name('admin.save_country');
Route::post('/detail-country'           , [CountryController::class, 'detail'])->name('admin.detail_country');
Route::post('/store-country'            , [CountryController::class, 'store'])->name('admin.store_country');
Route::post('/delete-country'           , [CountryController::class, 'delete'])->name('admin.delete_country');
## Home 
