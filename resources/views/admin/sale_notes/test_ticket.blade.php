...
<body>
    <div class="cabecera">
        ...
        <p style="font-size: 16px; font-weight: bold; margin-bottom: 0; margin-top: 10px;">ADRIANA'S E.I.R.L.</p>
        <p style="font-size: 10px; margin-top:0; margin-bottom: 0;">Av. Nuñez 113</p>
        <p style="font-size: 10px; margin-top:0; margin-bottom: 0;">Abancay - Abancay/p>
