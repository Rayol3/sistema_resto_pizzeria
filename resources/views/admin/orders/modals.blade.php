<div class="modal fade" id="modalConfirmSale" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form id="form-save-sale" class="modal-content" onsubmit="event.preventDefault()">
            @csrf
                                  ...
                                  <div class="form-group mb-1">
                                      <div class="el-select el-select--small" required="required">
                                          <div class="el-input el-input--small is-disabled el-input--suffix">
                                              <select class="form-control" id="modo_pago" name="modo_pago" disabled>
                                  ...
                                  <div class="form-group mb-1">
                                      <div class="text-end el-input-number el-input-number--small"  required="required">
                                          <div class="el-input el-input--small">
                                              <input type="text" autocomplete="off" max="Infinity" min="0" class="form-control" role="spinbutton" name="quantity_paying" readonly>
                                          </div>
                                      </div>
                                  </div>
                              </div>
