...
<html
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('admin.home') }}" class="app-brand-link">
                <span class="app-brand-logo demo">
                    <img src="{{ asset('assets/img/icons/icon-login1.svg') }}" alt=""
                        class="img-fluid">
                </span>
              <span class="app-brand-text demo menu-text fw-bold">PIZZERÍA</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">MENU PIZZERÍA ADRIANA</span>
            </li>
            ...
            <li class="menu-item {{ request()->is('comments') ? 'active' : '' }}">
              <a href="{{ route('admin.comments') }}" class="menu-link">
                <i class="menu-icon" data-feather="message-square"></i>
            ...
            @endcan
            @can('admin.products')
            <li class="menu-item {{ request()->is('products') || request()->is('categories') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <li class="menu-item {{ request()->is('list-cashes') || request()->is('series') || request()->is('countries') || request()->is('business') || request()->is('restaurant') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('restaurant') ? 'active' : '' }}">
                  <a href="{{ route('admin.restaurant') }}" class="menu-link">
                    <div data-i18n="Restaurante">Restaurante</div>
                  </a>
                </li>
    ...
    <script src="{{ asset('assets/vendor/multifile-master/jquery.MultiFile.js') }}"></script>
    ...
    <div style="position: fixed; bottom: 20px; right: 20px; z-index: 9999; opacity: 0.5; pointer-events: none;">
        <img src="{{ asset('img/marcaagua.svg') }}" alt="Watermark" style="width: 100px;">
    </div>
