<script>
    ...
    $('body').on('click', '.btn-detail', function()
    {
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                $.each(r.categorias, function(index, categoria){
                    if(categoria.id == r.product.idcategoria)
                    html_categorias += `<option value="${categoria.id}" selected>${categoria.descripcion}</option>`;
                    else
                    html_categorias += `<option value="${categoria.id}">${categoria.descripcion}</option>`;
                });
                ...
                $('#form_edit_product select[name="idcategoria"]').html(html_categorias).select2({
                    placeholder     : "[SELECCIONE]",
                    dropdownParent  : $('#modalEditProduct')
                });
    ...
    {
        event.preventDefault();
        let form            = new FormData($('#form_edit_product')[0]),
    ...
    $('body').on('click', '.btn-view', function()
    {
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                $('.detail-image').find('img').attr('src', `files/products/${r.data.imagen}`);
                console.log(r.data.imagen);
