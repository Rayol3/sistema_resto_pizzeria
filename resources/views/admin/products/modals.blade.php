<div class="modal fade" id="modalEditProduct" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form id="form_edit_product" class="modal-content" onsubmit="event.preventDefault()" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        <label class="form-label" for="idcategoria">Categor&iacute;a</label>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <label class="form-label" for="imagen">Imagen <small class="text-danger">(508 x 320 recomendado)</small></label>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="modalDetailProduct"
    ...
    <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
        <div class="price-details">
            ...
            <ul class="list-unstyled">
                <li class="img-detail">
                    <div class="detail-title fw-semibold detail-total">&nbsp;</div>
                    <div class="detail-image text-center"><img src="" class="img-responsive" alt="" width="95%"></div>
                </li>
            </ul>
        </div>
    </div>
